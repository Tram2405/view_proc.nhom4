...
/*proc1  Tạo một thủ tục  có tên là pro_Salary  để xét thưởng cuối năm:  
   - Nếu nhân viên làm trên : >= 10 năm thì lương thưởng là 15trieu 
   - Nếu nhân viên làm trên: > 6 năm thì thưởng 10trieu 
   - Nếu nhân viên làm trên: > 4 năm thì thưởng 8trieu 
   - Còn lại thì thưởng 6tr  */
delimiter $$
CREATE PROCEDURE proc_salary()
begin
select first_name ,  last_name , (YEAR(CURDATE()) - YEAR(hire_date)) AS years ,
case 
when (YEAR(CURDATE()) - YEAR(hire_date)) >= 10 then 15000
when (YEAR(CURDATE()) - YEAR(hire_date)) > 6 then 10000
when (YEAR(CURDATE()) - YEAR(hire_date)) > 4 then 8000
else 6000
